...
-file("src/lexer.erl", 319).
yystate() -> 35.

yystate(70, Ics, Line, Tlen, _, _) ->
    {17,Tlen,Ics,Line};
yystate(69, [69|Ics], Line, Tlen, Action, Alen) ->
...
yystate(68, Ics, Line, Tlen, _, _) ->
    {12,Tlen,Ics,Line,68};
yystate(67, [105|Ics], Line, Tlen, Action, Alen) ->
...
yystate(65, [116|Ics], Line, Tlen, Action, Alen) ->
...
yystate(58, Ics, Line, Tlen, _, _) ->
    {13,Tlen,Ics,Line,58};
yystate(57, [114|Ics], Line, Tlen, Action, Alen) ->
...
yystate(57, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(57, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 113 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(57, [C|Ics], Line, Tlen, Action, Alen) when C >= 115, C =< 122 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
...
yystate(55, [104|Ics], Line, Tlen, Action, Alen) ->
...
yystate(55, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(55, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 103 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(55, [C|Ics], Line, Tlen, Action, Alen) when C >= 105, C =< 122 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
...
yystate(53, [109|Ics], Line, Tlen, Action, Alen) ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(53, [108|Ics], Line, Tlen, Action, Alen) ->
    yystate(26, Ics, Line, Tlen+1, Action, Alen);
yystate(53, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(53, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(53, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 107 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(53, [C|Ics], Line, Tlen, Action, Alen) when C >= 111, C =< 122 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
...
yystate(51, [80|Ics], Line, Tlen, Action, Alen) ->
...
yystate(50, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(50, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 104 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(50, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 122 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
...
yystate(45, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(45, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 109 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(45, [C|Ics], Line, Tlen, Action, Alen) when C >= 111, C =< 122 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
...
yystate(38, [107|Ics], Line, Tlen, _, _) ->
...
yystate(38, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(30, Ics, Line, Tlen+1, 16, Tlen);
yystate(38, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 106 ->
    yystate(30, Ics, Line, Tlen+1, 16, Tlen);
yystate(38, [C|Ics], Line, Tlen, _, _) when C >= 108, C =< 122 ->
    yystate(30, Ics, Line, Tlen+1, 16, Tlen);
yystate(38, Ics, Line, Tlen, _, _) ->
    {16,Tlen,Ics,Line,38};
yystate(37, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(31, Ics, Line, Tlen+1, Action, Alen);
yystate(37, [C|Ics], Line, Tlen, Action, Alen) when C >= 11 ->
    yystate(31, Ics, Line, Tlen+1, Action, Alen);
...
yystate(35, [107|Ics], Line, Tlen, _, _) ->
    yystate(41, Ics, Line, Tlen+1, 8, Tlen);
yystate(35, [106|Ics], Line, Tlen, _, _) ->
...
yystate(35, [76|Ics], Line, Tlen, _, _) ->
    yystate(14, Ics, Line, Tlen+1, 8, Tlen);
yystate(35, [75|Ics], Line, Tlen, _, _) ->
    yystate(41, Ics, Line, Tlen+1, 8, Tlen);
...
yystate(35, [10|Ics], Line, Tlen, _, _) ->
    yystate(40, Ics, Line+1, Tlen+1, 8, Tlen);
yystate(35, [9|Ics], Line, Tlen, _, _) ->
    yystate(3, Ics, Line, Tlen+1, 8, Tlen);
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 49, C =< 57 ->
    yystate(33, Ics, Line, Tlen+1, 8, Tlen);
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 74 ->
    yystate(14, Ics, Line, Tlen+1, 8, Tlen);
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 78, C =< 90 ->
    yystate(14, Ics, Line, Tlen+1, 8, Tlen);
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 102 ->
    yystate(14, Ics, Line, Tlen+1, 8, Tlen);
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 112, C =< 118 ->
    yystate(14, Ics, Line, Tlen+1, 8, Tlen);
...
yystate(33, [107|Ics], Line, Tlen, _, _) ->
    yystate(21, Ics, Line, Tlen+1, 8, Tlen);
yystate(33, [77|Ics], Line, Tlen, _, _) ->
    yystate(21, Ics, Line, Tlen+1, 8, Tlen);
yystate(33, [75|Ics], Line, Tlen, _, _) ->
    yystate(21, Ics, Line, Tlen+1, 8, Tlen);
...
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 100 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
...
yystate(13, [120|Ics], Line, Tlen, Action, Alen) ->
...
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 110 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 112, C =< 122 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
...
yyaction_9(TokenChars, TokenLine) ->
     { token, { int, TokenLine, quantify_integer (TokenChars) } } .

...
yystate(64, [109|Ics], Line, Tlen, _, _) ->
    yystate(40, Ics, Line, Tlen+1, 9, Tlen);
yystate(64, [107|Ics], Line, Tlen, _, _) ->
    yystate(40, Ics, Line, Tlen+1, 9, Tlen);
yystate(64, [77|Ics], Line, Tlen, _, _) ->
    yystate(40, Ics, Line, Tlen+1, 9, Tlen);
...
yystate(58, [77|Ics], Line, Tlen, _, _) ->
    yystate(40, Ics, Line, Tlen+1, 10, Tlen);
yystate(58, [75|Ics], Line, Tlen, _, _) ->
    yystate(40, Ics, Line, Tlen+1, 10, Tlen);
yystate(58, [48|Ics], Line, Tlen, _, _) ->
...
yystate(48, [10|Ics], Line, Tlen, _, _) ->
    yystate(12, Ics, Line+1, Tlen+1, 1, Tlen);
...
yystate(47, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 107 ->
    yystate(44, Ics, Line, Tlen+1, 20, Tlen);
yystate(47, [C|Ics], Line, Tlen, _, _) when C >= 111, C =< 114 ->
    yystate(44, Ics, Line, Tlen+1, 20, Tlen);
yystate(47, [C|Ics], Line, Tlen, _, _) when C >= 116, C =< 122 ->
    yystate(44, Ics, Line, Tlen+1, 20, Tlen);
yystate(47, Ics, Line, Tlen, _, _) ->
    {20,Tlen,Ics,Line,47};
yystate(46, [80|Ics], Line, Tlen, Action, Alen) ->
...
yystate(43, Ics, Line, Tlen, _, _) ->
    {0,Tlen,Ics,Line};
yystate(42, [48|Ics], Line, Tlen, _, _) ->
...
yystate(21, Ics, Line, Tlen, _, _) ->
    {23,Tlen,Ics,Line};
yystate(20, [112|Ics], Line, Tlen, Action, Alen) ->
...
yystate(19, [C|Ics], Line, Tlen, Action, Alen) when C >= 11 ->
    yystate(13, Ics, Line, Tlen+1, Action, Alen);
...
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(44, Ics, Line, Tlen+1, 20, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 106 ->
    yystate(44, Ics, Line, Tlen+1, 20, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 108, C =< 122 ->
    yystate(44, Ics, Line, Tlen+1, 20, Tlen);
...
yystate(9, [107|Ics], Line, Tlen, _, _) ->
    yystate(17, Ics, Line, Tlen+1, 9, Tlen);
yystate(9, [106|Ics], Line, Tlen, _, _) ->
...
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 49, C =< 57 ->
    yystate(64, Ics, Line, Tlen+1, 9, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 74 ->
    yystate(44, Ics, Line, Tlen+1, 9, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 78, C =< 90 ->
    yystate(44, Ics, Line, Tlen+1, 9, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 104 ->
    yystate(44, Ics, Line, Tlen+1, 9, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 112, C =< 118 ->
    yystate(44, Ics, Line, Tlen+1, 9, Tlen);
